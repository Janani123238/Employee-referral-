function navItemsFor(role){
  ...
  if(role==='admin') return [
    ...
    ['resumeAnalysis','🔍','Resume Analysis'],['employees','👥','Employee Management'],
    ['interviews','🗓️','Interview Management'],['reports','📈','Reports & Analytics'],
    ['adminSettings','🔧','System Config'],['aiSettings','🤖','AI Settings'],
    ['userManagement','👤','User Management'],['emailTemplates','✉️','Email Templates'],['auditLogs','📋','Audit Logs'],['policy','📋','Referral Policy'],
  ];
  return [
    ['dashboard','📊','Dashboard'],['manageJobs','💼','Job Management'],['allReferrals','📋','Referral Management'],
    ['resumeAnalysis','🔍','Resume Analysis'],['employees','👥','Employees'],
    ['interviews','🗓️','Interview Management'],['reports','📈','Reports & Analytics'],['emailTemplates','✉️','Email Templates'],
    ...
    <div style="flex:1;min-width:0;">
      <div class="glass" style="margin:16px 18px 0;padding:12px 20px;display:flex;align-items:center;justify-content:space-between;position:sticky;top:16px;z-index:20;">
        <div style="display:flex;align-items:center;gap:10px;">
          <div style="font-size:13px;color:var(--ink-soft);">${state.role==='employee'?'Employee Portal':state.role==='admin'?'Admin Portal':'HR Portal'}</div>
